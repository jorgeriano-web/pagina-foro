/**
 * Punto de entrada de Cloud Functions: pagos (callables + schedulers), Sheets y reexport de cupos.
 * La lógica HTTP de “experiencias / cupos” vive en `http/callables/salaCuposCallables.ts`.
 */
...
import {
  getGatewayConfig,
  GATEWAY_CREDENTIALS,
} from "./configSecrets/gatewayConfig";
...
interface PagoRequest {
  ...
  asistentes: AsistenteData[];         // Array de 1 hasta 8 asistentes
...
export {
  ...
  listarSalasExperienciaProd,
  obtenerCupoPorUuidProd,
} from "./http/callables/salaCuposCallables";

export { guardarPreguntaSpeakerProd } from "./http/callables/preguntasSpeakersCallables";